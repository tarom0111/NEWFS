...
def masuk():
	...
	try:
		...
		os.system('clear')
		logo()
		print("\033[0;95m SILAHKAN LOGIN TOKEN NYA '\033[0;94mby FACE SPAMMER TOOLS\033[0;95m' UNTUK AMBIL TOKEN PAKAI APK BROWSER KIWI DAN PASANG EXTENSION GET COOKIE")
...
def menu():
	...
	try:
		...
		os.system('clear')
		print (' • MAAF TIDAK BISA CARI AKUN "ERROR"')
	...
	print" \033[0;91m  2. CARI DARI PENGIKUT"
	print" \033[0;92m  3. LIHAT HASIL AKUN"
...
def hamz_ganteng():
	...
	if ask == "":
		print
		print (" \033[0;97× YANG BENER YA") 
		exit()
	elif ask in["1","01"]:
		print ("\033[0;92mKETIK \033[093m 'me' \033[0;092mUNTUK CARI AKUN DARI DAFTAR TEMAN") 
		...
		print ("\n × ketik 'me' untuk CARI AKUN DARI daftar followers sendiri") 
	...
	def main(arg):
		...
		print '\r ** %s/%s live-:%s - CP-:%s ' % (loop, len(id), len(ok), len(cp)),
		sys.stdout.flush()
		user = arg
		uid,name=user.split(" ") 
		try:
...
def manual():
	...
	p = ThreadPool(30)
	p.map(main, id)
	print("\n *  Cari akunnya selsai jangan lupa salin hasil nya Ke NOTEPAD....")
	exit()
